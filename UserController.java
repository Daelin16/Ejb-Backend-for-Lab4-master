...
public class UserController {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("register")
    public Response register(UserCredentials userCredentials) throws InvalidKeySpecException, NoSuchAlgorithmException {
        String username = userCredentials.getUsername();
        String password = userCredentials.getPassword();
    ...
    @SneakyThrows
    private static String getPasswordHash(String password) throws NoSuchAlgorithmException, InvalidKeySpecException {
